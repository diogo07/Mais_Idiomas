...
/*
    ...
    public ArrayList<Palavra> listar(int nivel){
        ...
        StringBuilder sql_listar = new StringBuilder();
        sql_listar.append("select * from palavra where nivel = "+nivel+" order by nome;");
        Cursor cursor = sqLiteDatabase.rawQuery(sql_listar.toString(), null);
    ...
    public ArrayList<Palavra> listarPorPalavraChave(String p){
        ArrayList<Palavra> palavraList = new ArrayList<>();

        StringBuilder sql_listar = new StringBuilder();
        sql_listar.append("select * from palavra where nome like '%"+p+"%' or traducao like '%"+p+"%' order by nome;");
        Cursor cursor = sqLiteDatabase.rawQuery(sql_listar.toString(), null);
